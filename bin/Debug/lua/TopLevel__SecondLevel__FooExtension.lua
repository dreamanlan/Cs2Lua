...
TopLevel.SecondLevel.FooExtension = {
	...
	NormalMethod = function()
		...
		local v1; v1 = condaccess(dict, getexterninstanceindexer(dict, 1));
		local list; list = nil;
		local l; l = condaccess(list, list.Count);
		condaccess(list, listthis:Add(1));
		local v2; v2 = condaccess(list, setexterninstanceindexer(list, 3, 1));
		local arr2; arr2 = wraparray{1, 2, 3, 4};
		local v3; v3 = condaccess(arr2, arr2[3]);
