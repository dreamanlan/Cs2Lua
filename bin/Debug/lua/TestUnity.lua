	...
	__define_class = function()
		...
		local instance_methods = {
			Test = function(this, ...)
				...
				local v0; v0 = LINQ.begin().from(function() return v1s; end).let(function(v1) return v1.Value; end).let(function(v1, v3) return invokeforbasicvalue(invokeforbasicvalue(v3, false, System.Int32, "ToString"), false, System.String, "Split", wrapchar(' ', 0x020)); end).from(function(v1, v3, v4) return ( LINQ.begin().from(function() return v2s; end).select(function(v2) return v2; end).end() ); end).where(function(v1, v3, v4, vvvv) return (not System.String.IsNullOrEmpty(v1:ToString())); end).select(function(v1, v3, v4, vvvv) return v1:ToString(); end).end();
				local v5; v5 = LINQ.begin().from(function() return v1s; end).join((function(v1) return v2s; end), (function(v1, v2) return v1.Key; end), (function(v1, v2) return v2.Key; end)).into().select(function(v1, ttt0) return wrapdictionary{v1 = v1, v2 = ttt0:Count(System.Collections.Generic.KeyValuePair_TKey_TValue)}; end).continuation().groupby((function(ttt) return ttt; end), (function(ttt) return ttt.v2; end)).end();
