...
TopLevel.Singleton_T = {
	...
	__define_class = function()
		...
		return defineclass(nil, "TopLevel.Singleton_T", static, static_fields, static_props, static_events, instance_methods, instance_build, instance_props, instance_events, false);
	end,
};
