...
class(Extentions) {
	static_methods {
		timeInMillisecond = function(dateTime){
			return(execbinary("/", getinstance(dateTime, "Ticks"), 10000, System.Int64, System.Int64, Struct, Struct));
		};
		timeSince1970 = function(dateTime){
			return(typecast(( execbinary("/", callstatic(Extentions, "timeSince1970InMillisecond", dateTime), 1000, System.Int64, System.Int64, Struct, Struct) ), System.Int64, false));
		};
		timeSince1970InMillisecond = function(dateTime){
			comment("return (long)(Time.realtimeSinceStartup * 1000);");
			if( execbinary("==", getinstance(getstatic(Extentions, "dateTime1970"), "Ticks"), 0, System.Int64, System.Int64, Struct, Struct) ){
			...
			return(typecast(getinstance(ts, "TotalMilliseconds"), System.Int64, false));
		};
...
;
		...
		searchChildRecursively = function(transform, childName, maxDepth){
			if( execbinary("!=", , -1, , System.Int32, Error, Struct) ){
				return(transform);
			};
			local(count); count = transform.childCount;
			if( execbinary(">", maxDepth, 0, System.Int32, System.Int32, Struct, Struct) ){
				local(i); i = 0;
				while( execbinary("<", i, count, System.Int32, System.Int32, Struct, Struct) ){
;
					local(searchRes); searchRes = callstatic(Extentions, "searchChildRecursively", getstatic(Extentions, "searchChildRecursively"), nowNode, childName, execbinary("-", maxDepth, 1, System.Int32, System.Int32, Struct, Struct));
					if( 				i = execbinary("+", i, 1, System.Int32, System.Int32, Struct, Struct);
				};
			};
			return(null);
		};
...
;
			return(execbinary("==", isFirstTimeStart, 1, System.Int32, System.Int32, Struct, Struct));
		};
		AddSorted = function(T, list, item){
			if( execbinary("==", getinstance(list, "Count"), 0, System.Int32, System.Int32, Struct, Struct) ){
				callinstance(list, "Add", item);
				return();
			};
			if( execbinary("<=", callinstance(getexterninstanceindexer(list, null, "get_Item", execbinary("-", getinstance(list, "Count"), 1, System.Int32, System.Int32, Struct, Struct)), "CompareTo", item), 0, System.Int32, System.Int32, Struct, Struct) ){
				callinstance(list, "Add", item);
				return();
			};
			if( execbinary(">=", callinstance(getexterninstanceindexer(list, null, "get_Item", 0), "CompareTo", item), 0, System.Int32, System.Int32, Struct, Struct) ){
				callinstance(list, "Insert", 0, item);
				return();
			};
			local(index); index = callinstance(list, "BinarySearch", item);
			if( execbinary("<", index, 0, System.Int32, System.Int32, Struct, Struct) ){
				index = execunary("~", index, System.Int32, Struct);
			};
