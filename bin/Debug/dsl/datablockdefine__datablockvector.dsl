...
class(DataBlockDefine.DataBlockVector) {
	...
	instance_methods {
		...
		Release = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_IsValid"), System.Boolean, TypeKind.Structure), 1290_12_1291_23 ){
				return();
			};
		...
		Attach = deffunc(0)args(this, dataBlockId){
			...
			local(ix); ix = 0;
			while( execbinary("<", ix, ct, System.Int64, System.Int64, TypeKind.Structure, TypeKind.Structure) ){
				...
				callinterface(elem, DataBlockDefine.IDataBlock, "Attach", callstatic(DclApi, "uint64_vector_get_element", dataBlockId, typecast(ix, System.UInt64, TypeKind.Structure)));
		...
		Detach = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_IsValid"), System.Boolean, TypeKind.Structure), 1317_12_1318_23 ){
				return();
			};
		...
		Reserve = deffunc(0)args(this, space){
			...
			callstatic(DclApi, "container_reserve_space", getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataBlockId"), typecast(space, System.UInt64, TypeKind.Structure));
		...
		GetData = deffunc(1)args(this, T, index){
			...
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 1340_12_1342_13 ){
			...
			return(__method_ret_1338_8_1344_9);
		}options[needfuncinfo(false), rettype(T, DataBlockDefine.IDataBlock, TypeKind.TypeParameter, 0, false), paramtype(T, DataBlockDefine.IDataBlock, TypeKind.TypeParameter, 0, false), paramtype(index, System.Int32, TypeKind.Structure, 0, true)];
		SetData = deffunc(0)args(this, index, data){
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 1347_12_1350_13 ){
				...
				callstatic(DclApi, "uint64_vector_set_element", getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataBlockId"), typecast(index, System.UInt64, TypeKind.Structure), callinterface(data, DataBlockDefine.IDataBlock, "GetDataBlockId"));
			};
		}options[needfuncinfo(false), rettype(return, System.Void, TypeKind.Unknown, 0, false), paramtype(index, System.Int32, TypeKind.Structure, 0, true), paramtype(data, DataBlockDefine.IDataBlock, TypeKind.Interface, 0, false)];
		...
		}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Structure, 0, true), paramtype(data, DataBlockDefine.IDataBlock, TypeKind.Interface, 0, false)];
		GetLast = deffunc(1)args(this, T){
			local(__method_ret_1356_8_1359_9);
			__method_ret_1356_8_1359_9 = callinstance(this, DataBlockDefine.DataBlockVector, "GetData", T, execbinary("-", callinstance(this, DataBlockDefine.DataBlockVector, "GetCount"), 1, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure));
		...
		RemoveLast = deffunc(0)args(this){
			if( execbinary(">", getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), 1367_12_1370_13 ){
				callexterninstance(getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataWrap"), System.Collections.Generic.List_T, "RemoveAt", execbinary("-", getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), 1, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure));
		...
		RemoveAt = deffunc(0)args(this, index){
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 1379_12_1382_13 ){
				...
				callstatic(DclApi, "uint64_vector_erase", getinstance(SymbolKind.Field, this, DataBlockDefine.DataBlockVector, "m_DataBlockId"), typecast(index, System.UInt64, TypeKind.Structure));
			};
