...
class(Cs2LuaObjectPoolEx_DataChangeCallBackInfo) {
	...
	instance_methods {
		...
		Alloc = deffunc(1)args(this){
			...
			if( execbinary(">", getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, Cs2LuaObjectPoolEx_DataChangeCallBackInfo, "m_UnusedObjects"), System.Collections.Generic.Queue_T, "Count"), 0, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), 86_8_94_9 ){
				__method_ret_84_4_95_5 = callexterninstance(getinstance(SymbolKind.Field, this, Cs2LuaObjectPoolEx_DataChangeCallBackInfo, "m_UnusedObjects"), System.Collections.Generic.Queue_T, "Dequeue");
				...
				if( execbinary("!=", null, t, System.Object, System.Object, TypeKind.Class, TypeKind.Class), 90_12_92_13 ){
					callinterface(t, ICs2LuaPoolAllocatedObjectEx_DataChangeCallBackInfo, "InitPool", this);
				};
		...
		Recycle = deffunc(0)args(this, t){
			if( execbinary("!=", null, t, System.Object, System.Object, TypeKind.Class, TypeKind.Class), 98_8_100_9 ){
		...
		Clear = deffunc(0)args(this){
			if( delegationcomparewithnil(false, this, "m_Destroyer", SymbolKind.Field, false), 104_8_108_9 ){
				foreach(__foreach_105_12_107_13, item, getinstance(SymbolKind.Field, this, Cs2LuaObjectPoolEx_DataChangeCallBackInfo, "m_UnusedObjects"), System.Collections.Generic.Queue_T, System.Collections.Generic.Queue_T, true){
		...
		get_Count = deffunc(1)args(this){
			...
			__method_ret_111_4_116_5 = getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, Cs2LuaObjectPoolEx_DataChangeCallBackInfo, "m_UnusedObjects"), System.Collections.Generic.Queue_T, "Count");
