...
class(DataBlockDefine.Int16Array, DataBlockDefine.BaseIntegerArray, false) {
	...
	instance_methods {
		Reset = deffunc(0)args(this, size){
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 678_12_680_13 ){
		...
		GetData = deffunc(1)args(this, index){
			local(__method_ret_683_8_691_9);
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 685_12_690_13 ){
				__method_ret_683_8_691_9 = callstatic(DataBlockDefine.DclApi, "get_array_element_int16", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), typecast(index, System.UInt32, TypeKind.Struct));
				return(__method_ret_683_8_691_9);
			}else{
				__method_ret_683_8_691_9 = 0;
				return(__method_ret_683_8_691_9);
			};
			return(null);
		...
		SetData = deffunc(0)args(this, index, val){
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 694_12_696_13 ){
