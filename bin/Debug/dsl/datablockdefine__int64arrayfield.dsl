...
class(DataBlockDefine.Int64ArrayField, DataBlockDefine.BaseIntegerArray, false) {
	...
	instance_methods {
		GetData = deffunc(1)args(this, index){
			local(__method_ret_2348_8_2356_9);
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 2350_12_2355_13 ){
				__method_ret_2348_8_2356_9 = callstatic(DataBlockDefine.DclApi, "get_array_element_int64", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), typecast(index, System.UInt32, TypeKind.Struct));
				return(__method_ret_2348_8_2356_9);
			}else{
				__method_ret_2348_8_2356_9 = 0;
				return(__method_ret_2348_8_2356_9);
			};
			return(null);
