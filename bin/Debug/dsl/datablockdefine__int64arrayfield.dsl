...
class(DataBlockDefine.Int64ArrayField, DataBlockDefine.BaseIntegerArray, false) {
	...
	instance_methods {
		GetData = deffunc(1)args(this, index){
			...
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Structure, TypeKind.Structure), 2355_12_2360_13 ){
				__method_ret_2353_8_2361_9 = callstatic(DclApi, "get_array_element_int64", getinstance(SymbolKind.Field, this, DataBlockDefine.BaseIntegerArray, "m_DataBlockId"), typecast(index, System.UInt32, TypeKind.Structure));
