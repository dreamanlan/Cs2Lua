...
class(DataBlockDefine.StringVector) {
	...
	instance_methods {
		...
		Release = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_IsValid"), System.Boolean, TypeKind.Structure), 1148_12_1149_23 ){
				return();
			};
		...
		Attach = deffunc(0)args(this, dataBlockId){
			...
			local(ct); ct = typecast(callstatic(DclApi, "container_get_size", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataBlockId")), System.Int32, TypeKind.Structure);
			local(ix); ix = 0;
			while( execbinary("<", ix, ct, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure) ){
				local(strId); strId = callstatic(DclApi, "uint64_vector_get_element", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataBlockId"), typecast(ix, System.UInt64, TypeKind.Structure));
		...
		Detach = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_IsValid"), System.Boolean, TypeKind.Structure), 1171_12_1172_23 ){
				return();
			};
		...
		Reserve = deffunc(0)args(this, space){
			...
			callstatic(DclApi, "container_reserve_space", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataBlockId"), typecast(space, System.UInt64, TypeKind.Structure));
		...
		GetData = deffunc(1)args(this, index){
			...
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, callinstance(this, DataBlockDefine.StringVector, "GetCount"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 1192_12_1194_13 ){
		...
		SetData = deffunc(0)args(this, index, data){
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, callinstance(this, DataBlockDefine.StringVector, "GetCount"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 1199_12_1206_13 ){
				...
				callstatic(DclApi, "uint64_vector_set_element", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataBlockId"), typecast(index, System.UInt64, TypeKind.Structure), condexpfunc(true, retval_1205_78_1205_118, condexp_1205_78_1205_118, DataBlockDefine.StringVector, false, data){condexp(execbinary("==", null, data, System.Object, System.Object, TypeKind.Class, TypeKind.Class), true, 0, false, function(){ funcobjret(callinstance(data, DataBlockDefine.CString, "GetDataBlockId")); });}options[needfuncinfo(false), rettype(return, System.UInt64, TypeKind.Structure, 0, true), paramtype(data, DataBlockDefine.CString, Class, 0, false)]);
			};
		}options[needfuncinfo(false), rettype(return, System.Void, TypeKind.Unknown, 0, false), paramtype(index, System.Int32, TypeKind.Structure, 0, true), paramtype(data, DataBlockDefine.CString, TypeKind.Class, 0, false)];
		IndexOf = deffunc(1)args(this, data){
			local(__method_ret_1208_8_1215_9);
			local(ix); ix = 0;
			while( execbinary("<", ix, callinstance(this, DataBlockDefine.StringVector, "GetCount"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure) ){
			...
			return(__method_ret_1208_8_1215_9);
		}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Structure, 0, true), paramtype(data, DataBlockDefine.CString, TypeKind.Class, 0, false)];
		GetLast = deffunc(1)args(this){
			local(__method_ret_1216_8_1222_9);
			if( execbinary(">", callinstance(this, DataBlockDefine.StringVector, "GetCount"), 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), 1218_12_1221_28 ){
				__method_ret_1216_8_1222_9 = callinstance(this, DataBlockDefine.StringVector, "GetData", execbinary("-", callinstance(this, DataBlockDefine.StringVector, "GetCount"), 1, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure));
		...
		RemoveLast = deffunc(0)args(this){
			if( execbinary(">", getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), 1230_12_1237_13 ){
				local(oldData); oldData = getexterninstanceindexer(DataBlockDefine.CString, TypeKind.Class, System.Collections.Generic.List_T, getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataWrap"), System.Collections.Generic.List_T, "get_Item", 1, execbinary("-", getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), 1, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure));
				if( execbinary("!=", null, oldData, System.Object, System.Object, TypeKind.Class, TypeKind.Class), 1232_16_1234_17 ){
					callinstance(oldData, DataBlockDefine.CString, "Release");
				};
				callexterninstance(getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataWrap"), System.Collections.Generic.List_T, "RemoveAt", execbinary("-", getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), 1, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure));
		...
		Remove = deffunc(0)args(this, data){
			...
			if( execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), 1242_12_1247_13 ){
		...
		RemoveAt = deffunc(0)args(this, index){
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, callinstance(this, DataBlockDefine.StringVector, "GetCount"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 1251_12_1258_13 ){
				...
				callstatic(DclApi, "uint64_vector_erase", getinstance(SymbolKind.Field, this, DataBlockDefine.StringVector, "m_DataBlockId"), typecast(index, System.UInt64, TypeKind.Structure));
			};
