...
class(DataBlockDefine.Int64Vector) {
	...
	instance_methods {
		GetDataBlockId = deffunc(1)args(this){
			local(__method_ret_944_8_947_9);
			__method_ret_944_8_947_9 = getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_DataBlockId");
			return(__method_ret_944_8_947_9);
		}options[needfuncinfo(false), rettype(return, System.UInt64, TypeKind.Struct, 0, true)];
		Init = deffunc(0)args(this){
			if( getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_IsValid"), 950_12_951_23 ){
				return();
			};
		...
		Release = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_IsValid"), System.Boolean, TypeKind.Struct), 957_12_958_23 ){
				return();
			};
		...
		Attach = deffunc(0)args(this, dataBlockId){
			if( getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_IsValid"), 965_12_966_23 ){
				return();
			};
		...
		Detach = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_IsValid"), System.Boolean, TypeKind.Struct), 972_12_973_23 ){
				return();
			};
			setinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_DataBlockId", 0);
			setinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_IsValid", false);
		...
		GetCount = deffunc(1)args(this){
			local(__method_ret_982_8_985_9);
			__method_ret_982_8_985_9 = typecast(callstatic(DataBlockDefine.DclApi, "container_get_size", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_DataBlockId")), System.Int32, TypeKind.Struct);
			return(__method_ret_982_8_985_9);
		}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Struct, 0, true)];
		GetData = deffunc(1)args(this, index){
			local(__method_ret_986_8_992_9);
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), execbinary("<", index, callinstance(this, DataBlockDefine.Int64Vector, "GetCount"), System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 988_12_990_13 ){
				__method_ret_986_8_992_9 = callstatic(DataBlockDefine.DclApi, "int64_vector_get_element", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64Vector, "m_DataBlockId"), typecast(index, System.UInt64, TypeKind.Struct));
				return(__method_ret_986_8_992_9);
			};
			__method_ret_986_8_992_9 = 0;
			return(__method_ret_986_8_992_9);
		...
		SetData = deffunc(0)args(this, index, data){
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), execbinary("<", index, callinstance(this, DataBlockDefine.Int64Vector, "GetCount"), System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 995_12_997_13 ){
		...
		IndexOf = deffunc(1)args(this, data){
			local(__method_ret_999_8_1006_9);
			local(ix); ix = 0;
			while( execbinary("<", ix, callinstance(this, DataBlockDefine.Int64Vector, "GetCount"), System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct) ){
				if( execbinary("==", callinstance(this, DataBlockDefine.Int64Vector, "GetData", ix), data, System.Int64, System.Int64, TypeKind.Struct, TypeKind.Struct), 1002_16_1003_30 ){
					__method_ret_999_8_1006_9 = ix;
					return(__method_ret_999_8_1006_9);
				};
			ix = execbinary("+", ix, 1, null, null, null, null);
			};
			__method_ret_999_8_1006_9 = -1;
			return(__method_ret_999_8_1006_9);
		...
		GetLast = deffunc(1)args(this){
			local(__method_ret_1007_8_1010_9);
			__method_ret_1007_8_1010_9 = callinstance(this, DataBlockDefine.Int64Vector, "GetData", execbinary("-", callinstance(this, DataBlockDefine.Int64Vector, "GetCount"), 1, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct));
			return(__method_ret_1007_8_1010_9);
		...
		RemoveAt = deffunc(0)args(this, index){
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), execbinary("<", index, callinstance(this, DataBlockDefine.Int64Vector, "GetCount"), System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 1026_12_1028_13 ){
