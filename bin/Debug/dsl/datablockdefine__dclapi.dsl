...
class(DataBlockDefine.DclApi) {
	static_methods {
		get_string = deffunc(1)args(id){
			local(__method_ret_271_8_278_9);
			local(v); v = callstatic(DataBlockDefine.DclApi, "get_cstring", id);
			if( execbinary("==", callexterninstancereturnstruct(v, System.IntPtr, "ToPointer"), null, , , TypeKind.Pointer, TypeKind.Pointer), 274_12_276_13 ){
				__method_ret_271_8_278_9 = null;
				return(__method_ret_271_8_278_9);
			};
			__method_ret_271_8_278_9 = callexternstatic(System.Runtime.InteropServices.Marshal, "PtrToStringAnsi__IntPtr", wrapexternstructargument(v, System.IntPtr, OperationKind.LocalReference, SymbolKind.Local));
			return(__method_ret_271_8_278_9);
