...
class(DataBlockDefine.StringDataBlockMap) {
	...
	instance_methods {
		...
		Release = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_IsValid"), System.Boolean, TypeKind.Struct), 2194_12_2195_23 ){
				return();
			};
		...
		Attach = deffunc(0)args(this, dataBlockId){
			...
			if( execbinary("!=", dataBlockId, 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 2206_12_2215_13 ){
		...
		Detach = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_IsValid"), System.Boolean, TypeKind.Struct), 2220_12_2221_23 ){
				return();
			};
		...
		GetData = deffunc(1)args(this, T, key){
			...
			if( execbinary("&&", execbinary("!=", null, key, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execbinary("!=", callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 2240_12_2246_13 ){
				...
				if( execclosure(true, __invoke_2243_20_2243_53, true){ multiassign(precode{
					...
					})varlist(__invoke_2243_20_2243_53, kv) = callexternstructdictionaryinstance(4, [System.Collections.Generic.Dictionary_TKey_TValue, System.UInt64, TypeKind.Struct, DataBlockDefine.StringDataBlockMap.KeyValue, TypeKind.Struct], [null, null, null, null, System.UInt64, TypeKind.Struct, OperationKind.LocalReference, SymbolKind.Local], [null, null, null, null, DataBlockDefine.StringDataBlockMap.KeyValue, TypeKind.Struct, OperationKind.LocalReference, SymbolKind.Local], getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_DataWrap"), System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", k, __cs2dsl_out); }, 2243_16_2245_17 ){
		...
		SetData = deffunc(0)args(this, key, val){
			if( execbinary("&&", execbinary("!=", null, key, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execbinary("!=", callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 2251_12_2273_13 ){
				...
				if( execbinary("!=", oldKey, mapKey, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 2254_16_2262_17 ){
					local(kv);
					if( execclosure(true, __invoke_2256_24_2256_62, true){ multiassign(precode{
						},postcode{
							kv = wrapstruct(kv, DataBlockDefine.StringDataBlockMap.KeyValue);
						})varlist(__invoke_2256_24_2256_62, kv) = callexternstructdictionaryinstance(4, [System.Collections.Generic.Dictionary_TKey_TValue, System.UInt64, TypeKind.Struct, DataBlockDefine.StringDataBlockMap.KeyValue, TypeKind.Struct], [null, null, null, null, System.UInt64, TypeKind.Struct, OperationKind.LocalReference, SymbolKind.Local], [null, null, null, null, DataBlockDefine.StringDataBlockMap.KeyValue, TypeKind.Struct, OperationKind.LocalReference, SymbolKind.Local], getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_DataWrap"), System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", oldKey, __cs2dsl_out); }, 2256_20_2261_21 ){
				...
				if( execbinary("!=", mapKey, callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), 2263_16_2272_17 ){
		...
		Add = deffunc(0)args(this, key, val){
			if( execbinary("&&", execbinary("!=", null, key, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execbinary("!=", callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 2277_12_2284_13 ){
				local(mapKey); mapKey = callstatic(DclApi, "string_uint64_map_add_element", getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_DataBlockId"), callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), condexpfunc(true, retval_2278_105_2278_143, condexp_2278_105_2278_143, DataBlockDefine.StringDataBlockMap, false, val){condexp(execbinary("==", null, val, System.Object, System.Object, TypeKind.Class, TypeKind.Class), true, 0, false, function(){ funcobjret(callinterface(val, DataBlockDefine.IDataBlock, "GetDataBlockId")); });}options[needfuncinfo(false), rettype(return, System.UInt64, TypeKind.Struct, 0, true), paramtype(val, DataBlockDefine.IDataBlock, Interface, 0, false)]);
				local(newKV); newKV = newstruct(DataBlockDefine.StringDataBlockMap.KeyValue, "g_DataBlockDefine_StringDataBlockMap_KeyValue", typeargs(), typekinds(), "ctor", 0, null);
				setinstance(SymbolKind.Field, newKV, DataBlockDefine.StringDataBlockMap.KeyValue, "Key", newobject(DataBlockDefine.CString, "g_DataBlockDefine_CString", typeargs(), typekinds(), "ctor", 0, null));
				callinstance(getinstance(SymbolKind.Field, newKV, DataBlockDefine.StringDataBlockMap.KeyValue, "Key"), DataBlockDefine.CString, "Attach", mapKey);
				setinstance(SymbolKind.Field, newKV, DataBlockDefine.StringDataBlockMap.KeyValue, "Value", val);
		...
		Remove = deffunc(0)args(this, key){
			if( execbinary("&&", execbinary("!=", null, key, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execbinary("!=", callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 2288_12_2298_13 ){
				...
				if( execclosure(true, __invoke_2291_20_2291_58, true){ multiassign(precode{
						...
						kv = wrapstruct(kv, DataBlockDefine.StringDataBlockMap.KeyValue);
					})varlist(__invoke_2291_20_2291_58, kv) = callexternstructdictionaryinstance(4, [System.Collections.Generic.Dictionary_TKey_TValue, System.UInt64, TypeKind.Struct, DataBlockDefine.StringDataBlockMap.KeyValue, TypeKind.Struct], [null, null, null, null, System.UInt64, TypeKind.Struct, OperationKind.LocalReference, SymbolKind.Local], [null, null, null, null, DataBlockDefine.StringDataBlockMap.KeyValue, TypeKind.Struct, OperationKind.LocalReference, SymbolKind.Local], getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_DataWrap"), System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", mapKey, __cs2dsl_out); }, 2291_16_2296_17 ){
					callinstance(getinstance(SymbolKind.Field, kv, DataBlockDefine.StringDataBlockMap.KeyValue, "Key"), DataBlockDefine.CString, "Release");
		...
		Contains = deffunc(1)args(this, key){
			...
			if( execbinary("&&", execbinary("!=", null, key, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execbinary("!=", callinstance(key, DataBlockDefine.CString, "GetDataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Struct, TypeKind.Struct), System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 2302_12_2304_13 ){
		...
		Iterate = deffunc(0)args(this, callback){
			foreach(__foreach_2321_12_2325_13, pair, getinstance(SymbolKind.Field, this, DataBlockDefine.StringDataBlockMap, "m_DataWrap"), System.Collections.Generic.Dictionary_TKey_TValue, System.Collections.Generic.Dictionary_TKey_TValue, true){
				local(kv); kv = getexterninstancestructmember(SymbolKind.Property, pair, System.Collections.Generic.KeyValuePair_TKey_TValue, "Value");
				if( execunary("!", callexterndelegation(callback, "System.Func_T1_T2_TResult.Invoke", getinstance(SymbolKind.Field, kv, DataBlockDefine.StringDataBlockMap.KeyValue, "Key"), getinstance(SymbolKind.Field, kv, DataBlockDefine.StringDataBlockMap.KeyValue, "Value")), System.Boolean, TypeKind.Struct), 2323_16_2324_26 ){
					block{
					break;
					};
				};
