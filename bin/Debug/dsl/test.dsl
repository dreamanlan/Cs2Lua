...
class(Test) {
	...
	instance_methods {
		Init = deffunc(0)args(this){
			callinstance(getinstance(SymbolKind.Field, this, Test, "m_DataChangeCallBackInfoPool"), Cs2LuaObjectPoolEx_DataChangeCallBackInfo, "Init__Func_1_TResult__Action_1_T", null, null);
			...
			callexterninstance(strlist, System.Collections.Generic.List_T, "Sort__Comparison_1_Object", deffunc(1)args(a, b){ local(__lambda_112_21_112_45); __lambda_112_21_112_45 = invokeforbasicvalue(a, false, System.String, "CompareTo__String", b); return(__lambda_112_21_112_45); }options[needfuncinfo(false)]);
			...
			callexterninstance(intlist, System.Collections.Generic.List_T, "Sort__Comparison_1_Object", deffunc(1)args(a, b){ local(__lambda_115_21_115_45); __lambda_115_21_115_45 = invokeforbasicvalue(a, false, System.Int32, "CompareTo__Int32", b); return(__lambda_115_21_115_45); }options[needfuncinfo(false)]);
		}options[needfuncinfo(false)];
