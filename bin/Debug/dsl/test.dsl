...
class(Test) {
	static_methods {
		...
		op_Implicit = deffunc(1)args(v){
			local(__method_ret_237_4_240_5);
			__method_ret_237_4_240_5 = newexternobject(System.Exception, "g_System_Exception", typeargs(), typekinds(), "ctor__String", 0, null, callbasicvalue(v, false, System.Int32, "ToString"));
			return(__method_ret_237_4_240_5);
			return(null);
		...
		ToList = deffunc(1)args(T, enumer){
			local(__method_ret_358_4_366_5);
			...
			foreach(__foreach_362_8_364_9, v, enumer, System.Collections.Generic.IEnumerable_T, System.Collections.Generic.IEnumerable_T, true){
				callexterninstance(r, System.Collections.Generic.List_T, "Add", v);
			};
			__method_ret_358_4_366_5 = r;
			return(__method_ret_358_4_366_5);
		...
		ToArray = deffunc(1)args(T, list){
			local(__method_ret_367_4_372_5);
			...
			__method_ret_367_4_372_5 = arr;
			return(__method_ret_367_4_372_5);
	...
	instance_methods {
		get_Item = deffunc(1)args(this, ...){
			local(__method_ret_241_4_245_5);
			local(args); args = params(System.Nullable_T, TypeKind.Struct);
			local(args); args = params(System.Nullable_T, TypeKind.Struct);
			__method_ret_241_4_245_5 = arraygetstruct(false, SymbolKind.Parameter, System.Nullable_T, args, 1, 1);
			return(__method_ret_241_4_245_5);
		...
		Init = deffunc(0)args(this){
			...
			multiassign(precode{
					local(__old_var_0_269_8_269_27); __old_var_0_269_8_269_27 = getinstance(SymbolKind.Field, this, Test, "s_V1");
				},postcode{
					...
					local(__new_var_0_269_8_269_27); __new_var_0_269_8_269_27 = getinstance(SymbolKind.Field, this, Test, "s_V1");
					recycleandkeepstructvalue(UnityEngine.Vector3, __old_var_0_269_8_269_27, __new_var_0_269_8_269_27);
				})varlist(getinstance(SymbolKind.Field, this, Test, "s_V1")) = callinstance(this, Test, "TestOneV3", __cs2dsl_out);
			multiassign(precode{
					local(__old_var_0_270_8_270_37); __old_var_0_270_8_270_37 = getinstance(SymbolKind.Field, this, Test, "s_V1");
					local(__old_var_1_270_8_270_37); __old_var_1_270_8_270_37 = getinstance(SymbolKind.Field, this, Test, "s_V2");
				},postcode{
					getinstance(SymbolKind.Field, this, Test, "s_V1") = wrapexternstruct(getinstance(SymbolKind.Field, this, Test, "s_V1"), UnityEngine.Vector3);
					...
					local(__new_var_0_270_8_270_37); __new_var_0_270_8_270_37 = getinstance(SymbolKind.Field, this, Test, "s_V1");
					local(__new_var_1_270_8_270_37); __new_var_1_270_8_270_37 = getinstance(SymbolKind.Field, this, Test, "s_V2");
					recycleandkeepstructvalue(UnityEngine.Vector3, __old_var_0_270_8_270_37, __new_var_0_270_8_270_37);
					recycleandkeepstructvalue(UnityEngine.Vector3, __old_var_1_270_8_270_37, __new_var_1_270_8_270_37);
		...
		TestImp = deffunc(0)args(this, pos){
			...
			local(v);
			if( execbinary("&&", execbinary("!=", null, dict, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execclosure(true, __invoke_279_28_279_58, true){ multiassign(precode{
				},postcode{
				})varlist(__invoke_279_28_279_58, v) = callexterninstance(dict, System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", dslstrtocsstr("abc"), __cs2dsl_out); }, System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 279_8_284_9 ){
				callexternstatic(System.Console, "WriteLine__String", v);
			}elseif( execbinary("&&", execbinary("!=", null, dict, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execclosure(true, __invoke_282_31_282_62, true){ multiassign(precode{
				},postcode{
				})varlist(__invoke_282_31_282_62, v) = callexterninstance(dict, System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", dslstrtocsstr("abc2"), __cs2dsl_out); }, System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct), 282_8_284_9 ){
				callexternstatic(System.Console, "WriteLine__String", v);
			};
			while( execbinary("&&", execbinary("!=", null, dict, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execclosure(true, __invoke_285_30_285_61, true){ multiassign(precode{
				},postcode{
				})varlist(__invoke_285_30_285_61, v) = callexterninstance(dict, System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", dslstrtocsstr("abc2"), __cs2dsl_out); }, System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct) ){
				callexternstatic(System.Console, "WriteLine__String", v);
			};
			do{
				callexternstatic(System.Console, "WriteLine__String", v);
			}while(execbinary("&&", execbinary("!=", null, dict, System.Object, System.Object, TypeKind.Class, TypeKind.Class), execclosure(true, __invoke_290_33_290_64, true){ multiassign(precode{
				},postcode{
				})varlist(__invoke_290_33_290_64, v) = callexterninstance(dict, System.Collections.Generic.Dictionary_TKey_TValue, "TryGetValue", dslstrtocsstr("abc2"), __cs2dsl_out); }, System.Boolean, System.Boolean, TypeKind.Struct, TypeKind.Struct));
			local(vv); vv = getexternstaticstructmember(SymbolKind.Property, UnityEngine.Vector3, "zero");
			setexterninstance(SymbolKind.Field, vv, UnityEngine.Vector3, "x", condexpfunc(true, retval_293_15_293_55, condexp_293_15_293_55, Test, false, v){condexp(execbinary("==", v, "yes", System.String, System.String, TypeKind.Class, TypeKind.Class), true, 123, false, function(){ funcobjret(condexpfunc(true, retval_293_34_293_55, condexp_293_34_293_55, Test, false, v){condexp(execbinary("==", v, "no", System.String, System.String, TypeKind.Class, TypeKind.Class), true, 456, true, 789);}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(v, System.String, Class, 0, true)]); });}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(v, System.String, Class, 0, true)]);
			local(iv); iv = condexpfunc(true, retval_294_17_294_57, condexp_294_17_294_57, Test, false, v){condexp(execbinary("==", v, "yes", System.String, System.String, TypeKind.Class, TypeKind.Class), true, 123, false, function(){ funcobjret(condexpfunc(true, retval_294_36_294_57, condexp_294_36_294_57, Test, false, v){condexp(execbinary("==", v, "no", System.String, System.String, TypeKind.Class, TypeKind.Class), true, 456, true, 789);}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(v, System.String, Class, 0, true)]); });}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(v, System.String, Class, 0, true)];
			callinterface(list, System.Collections.Generic.ICollection_T, "Add", condexpfunc(true, retval_295_17_295_57, condexp_295_17_295_57, Test, false, v){condexp(execbinary("==", v, "yes", System.String, System.String, TypeKind.Class, TypeKind.Class), true, 123, false, function(){ funcobjret(condexpfunc(true, retval_295_36_295_57, condexp_295_36_295_57, Test, false, v){condexp(execbinary("==", v, "no", System.String, System.String, TypeKind.Class, TypeKind.Class), true, 456, true, 789);}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(v, System.String, Class, 0, true)]); });}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(v, System.String, Class, 0, true)]);
			local(statusA); statusA = 3;
			statusA = condexpfunc(true, retval_297_18_297_84, condexp_297_18_297_84, Test, false, statusA){condexp(execbinary("==", statusA, 1, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), true, 2, false, function(){ funcobjret(condexpfunc(true, retval_297_37_297_84, condexp_297_37_297_84, Test, false, statusA){condexp(execbinary("==", statusA, 2, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), true, 1, false, function(){ funcobjret(condexpfunc(true, retval_297_56_297_84, condexp_297_56_297_84, Test, false, statusA){condexp(execbinary("==", statusA, 3, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), true, 0, false, function(){ funcobjret(prefixoperator(true, statusA, execbinary("+", statusA, 1, null, null, null, null))); });}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(statusA, System.Int32, Struct, 0, true)]); });}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(statusA, System.Int32, Struct, 0, true)]); });}options[needfuncinfo(true), rettype(return, System.Int32, TypeKind.Struct, 0, true), paramtype(statusA, System.Int32, Struct, 0, true)];
		...
		testcall = deffunc(1)args(this){
			local(__method_ret_299_4_311_5);
			...
			c32 = callexterndelegationreturnstruct(( typecast(( deffunc(1)args(){
				local(__method_ret_306_31_306_50);
				__method_ret_306_31_306_50 = invokeexternoperatorreturnstruct(UnityEngine.Color32, UnityEngine.Color32, "op_Implicit__Color32__Color", wrapexternstructargument(c, UnityEngine.Color, OperationKind.LocalReference, SymbolKind.Local));
				return(__method_ret_306_31_306_50);
			...
			c32 = callexterndelegationreturnstruct(( typecast(( deffunc(1)args(){ local(__lambda_307_31_307_38); __lambda_307_31_307_38 = invokeexternoperatorreturnstruct(UnityEngine.Color32, UnityEngine.Color32, "op_Implicit__Color32__Color", wrapexternstructargument(c, UnityEngine.Color, OperationKind.LocalReference, SymbolKind.Local)); return(__lambda_307_31_307_38); }options[needfuncinfo(true), rettype(return, UnityEngine.Color32, TypeKind.Struct, 0, true)] ), "System.Func_TResult", TypeKind.Delegate) ), "System.Func_TResult.Invoke");
			local(data); data = 1;
			local(v); v = typecast(data, System.Int32, TypeKind.Struct);
			__method_ret_299_4_311_5 = 1;
			return(__method_ret_299_4_311_5);
		...
		testimp = deffunc(1)args(this){
			local(__method_ret_312_4_312_66);
			local(__expbody_312_4_312_66); __expbody_312_4_312_66 = invokeexternoperatorreturnstruct(UnityEngine.Color32, UnityEngine.Color32, "op_Implicit__Color32__Color", getexternstaticstructmember(SymbolKind.Property, UnityEngine.Color, "red")); return(__expbody_312_4_312_66);
		}options[needfuncinfo(true), rettype(return, UnityEngine.Color32, TypeKind.Struct, 0, true)];
		get_testimp2 = deffunc(1)args(this){
			local(__expbody_313_4_313_65); __expbody_313_4_313_65 = invokeexternoperatorreturnstruct(UnityEngine.Color32, UnityEngine.Color32, "op_Implicit__Color32__Color", getexternstaticstructmember(SymbolKind.Property, UnityEngine.Color, "red")); return(__expbody_313_4_313_65);
		}options[needfuncinfo(true), rettype(return, UnityEngine.Color32, TypeKind.Struct, 0, true)],
		test = deffunc(1)args(this){
			local(__method_ret_314_4_352_5);
			local(a); a = 2;
			local(b); b = 0;
			local(c); c = 1;
			local(aa); aa = deffunc(1)args(){
				local(__method_ret_317_31_330_9);
				local(__try_ret_318_12_323_13, __try_retval_318_12_323_13); multiassign(__try_ret_318_12_323_13, __try_retval_318_12_323_13) = dsltry(false, __try_ret_318_12_323_13){
					callexternstatic(System.Console, "Write__String", dslstrtocsstr("test"));
				};
				local(__catch_handled_318_12_323_13, __catch_retval_318_12_323_13); __catch_handled_318_12_323_13 = false;
				__catch_retval_318_12_323_13 = dslcatch(__catch_handled_318_12_323_13, __try_retval_318_12_323_13, __try_ret_318_12_323_13,
					function(ex){
						__catch_handled_318_12_323_13 = true;
					}
				);
				local(__try_ret_324_12_329_13, __try_retval_324_12_329_13); multiassign(__try_ret_324_12_329_13, __try_retval_324_12_329_13) = dsltry(false, __try_ret_324_12_329_13){
					block{
					__method_ret_317_31_330_9 = lualib_call(2, [null], this, Test, "testcall");
					__try_retval_324_12_329_13 = 1;
					break;
					};
				};
				if(__try_ret_324_12_329_13){
					if(__try_retval_324_12_329_13){
					if(__try_retval_324_12_329_13==1){
						return(__method_ret_317_31_330_9);
					};
					};
				};
				local(__catch_handled_324_12_329_13, __catch_retval_324_12_329_13); __catch_handled_324_12_329_13 = false;
				__catch_retval_324_12_329_13 = dslcatch(__catch_handled_324_12_329_13, __try_retval_324_12_329_13, __try_ret_324_12_329_13,
					function(ex){
						__catch_handled_324_12_329_13 = true;
						block{
						__method_ret_317_31_330_9 = 0;
						return(1);
						};
					}
				);
				if(__catch_retval_324_12_329_13){
				if(__catch_retval_324_12_329_13==1){
					return(__method_ret_317_31_330_9);
				};
				};
				return(null);
			}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Struct, 0, true)];
			local(__try_ret_332_8_337_9, __try_retval_332_8_337_9); multiassign(__try_ret_332_8_337_9, __try_retval_332_8_337_9) = dsltryfunc(__try_ret_332_8_337_9, __try_retval_332_8_337_9, __try_func_332_8_337_9, Test, false, 2){
				callexternstatic(System.Console, "Write__String", dslstrtocsstr("test"));
			}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Struct, 0, true)];
			local(__catch_handled_332_8_337_9, __catch_retval_332_8_337_9); __catch_handled_332_8_337_9 = false;
			__catch_retval_332_8_337_9 = dslcatch(__catch_handled_332_8_337_9, __try_retval_332_8_337_9, __try_ret_332_8_337_9,
				function(ex){
					__catch_handled_332_8_337_9 = true;
				}
			);
			local(intlist); intlist = newexternlist(System.Collections.Generic.List_T, "g_System_Collections_Generic_List_System_Int32", typeargs(System.Int32), typekinds(TypeKind.Struct), "ctor", 0, literallist("g_System_Collections_Generic_List_System_Int32", typeargs(System.Int32), typekinds(TypeKind.Struct)));
			local(__try_retval_339_8_349_9_0); __try_retval_339_8_349_9_0 = __method_ret_314_4_352_5;
			local(__try_ret_339_8_349_9, __try_retval_339_8_349_9); multiassign(__try_ret_339_8_349_9, __try_retval_339_8_349_9, __try_retval_339_8_349_9_0) = dsltryfunc(__try_ret_339_8_349_9, __try_retval_339_8_349_9, __try_func_339_8_349_9, Test, false, 2, __method_ret_314_4_352_5, aa){
				block{
				__method_ret_314_4_352_5 = callexterndelegation(aa, "System.Func_TResult.Invoke");
				return(1, __method_ret_314_4_352_5);
				};
			}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Struct, 0, true), rettype(__method_ret_314_4_352_5, System.Int32, TypeKind.Struct, 1, true), paramtype(__method_ret_314_4_352_5, System.Int32, TypeKind.Struct, 1, true), paramtype(aa, System.Func_TResult, Delegate, 0, true)];
			if(__try_ret_339_8_349_9){
				__method_ret_314_4_352_5 = __try_retval_339_8_349_9_0;
			};
			if(__try_ret_339_8_349_9){
				callexternstatic(System.Console, "WriteLine__String__Object__Object__Object", dslstrtocsstr("{0} {1} {2}"), a, b, c);
				if(__try_retval_339_8_349_9){
				if(__try_retval_339_8_349_9==1){
					return(__method_ret_314_4_352_5);
				};
				};
			};
			local(__catch_handled_339_8_349_9, __catch_retval_339_8_349_9); __catch_handled_339_8_349_9 = false;
			__catch_retval_339_8_349_9 = dslcatch(__catch_handled_339_8_349_9, __try_retval_339_8_349_9, __try_ret_339_8_349_9,
				function(e){
					if(typeis(e, System.ArgumentException, TypeKind.Class)){
						__catch_handled_339_8_349_9 = true;
						callexternstatic(System.Console, "WriteLine__String__Object__Object__Object", dslstrtocsstr("ex:{0} {1} {2}"), a, b, c);
						dslthrow(a);
						block{
						__method_ret_314_4_352_5 = 0;
						return(1);
						};
					};
				}
			...
			callexternstatic(System.Console, "WriteLine__String__Object__Object__Object", dslstrtocsstr("{0} {1} {2}"), a, b, c);
			if(__catch_retval_339_8_349_9){
			if(__catch_retval_339_8_349_9==1){
				return(__method_ret_314_4_352_5);
			};
			};
			if(! __try_ret_339_8_349_9){
			...
			setinstance(SymbolKind.Field, this, Test, "m_IntVal", condexpfunc(true, retval_351_24_351_40, condexp_351_24_351_40, Test, false){condexp(execbinary(">", a, 1, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct), false, function(){ funcobjret(callexterndelegation(aa, "System.Func_TResult.Invoke")); }, false, function(){ funcobjret(c); });}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Struct, 0, true)]);
			return(__method_ret_314_4_352_5);
		}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Struct, 0, true)];
