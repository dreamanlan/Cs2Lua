...
class(DataBlockDefine.StringArrayField) {
	...
	instance_methods {
		...
		Release = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.StringArrayField, "m_IsValid"), System.Boolean, TypeKind.Structure), 2389_12_2390_23 ){
				return();
			};
			...
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.StringArrayField, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Structure, TypeKind.Structure), 2395_12_2398_13 ){
		...
		Attach = deffunc(0)args(this, dataBlockId){
			...
			local(ix); ix = 0;
			while( execbinary("<", ix, typecast(len, System.UInt32, TypeKind.Structure), System.UInt32, System.UInt32, TypeKind.Structure, TypeKind.Structure) ){
		...
		Detach = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.StringArrayField, "m_IsValid"), System.Boolean, TypeKind.Structure), 2416_12_2417_23 ){
				return();
			};
		...
		GetLength = deffunc(1)args(this){
			...
			if( execbinary("!=", getinstance(SymbolKind.Field, this, DataBlockDefine.StringArrayField, "m_DataBlockId"), 0, System.UInt64, System.UInt64, TypeKind.Structure, TypeKind.Structure), 2427_12_2432_13 ){
		...
		GetData = deffunc(1)args(this, index){
			...
			if( execbinary("&&", execbinary(">=", index, 0, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), execbinary("<", index, getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, DataBlockDefine.StringArrayField, "m_DataWrap"), System.Collections.Generic.List_T, "Count"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), System.Boolean, System.Boolean, TypeKind.Structure, TypeKind.Structure), 2436_12_2441_13 ){
