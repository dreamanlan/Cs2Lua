...
class(DataBlockDefine.Int64StringMap) {
	...
	instance_methods {
		...
		Release = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64StringMap, "m_IsValid"), System.Boolean, TypeKind.Structure), 1555_12_1556_23 ){
				return();
			};
		...
		Attach = deffunc(0)args(this, dataBlockId){
			...
			if( execbinary("!=", dataBlockId, 0, System.UInt64, System.UInt64, TypeKind.Structure, TypeKind.Structure), 1567_12_1574_13 ){
		...
		Detach = deffunc(0)args(this){
			if( execunary("!", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64StringMap, "m_IsValid"), System.Boolean, TypeKind.Structure), 1579_12_1580_23 ){
				return();
			};
		...
		}options[needfuncinfo(false), rettype(return, DataBlockDefine.CString, TypeKind.Class, 0, false), paramtype(key, System.Int64, TypeKind.Structure, 0, true)];
		SetData = deffunc(0)args(this, key, val){
			...
			callstatic(DclApi, "int64_uint64_map_set_element", getinstance(SymbolKind.Field, this, DataBlockDefine.Int64StringMap, "m_DataBlockId"), key, condexpfunc(true, retval_1608_68_1608_106, condexp_1608_68_1608_106, DataBlockDefine.Int64StringMap, false, val){condexp(execbinary("==", null, val, System.Object, System.Object, TypeKind.Class, TypeKind.Class), true, 0, false, function(){ funcobjret(callinstance(val, DataBlockDefine.CString, "GetDataBlockId")); });}options[needfuncinfo(false), rettype(return, System.UInt64, TypeKind.Structure, 0, true), paramtype(val, DataBlockDefine.CString, Class, 0, false)]);
		}options[needfuncinfo(false), rettype(return, System.Void, TypeKind.Unknown, 0, false), paramtype(key, System.Int64, TypeKind.Structure, 0, true), paramtype(val, DataBlockDefine.CString, TypeKind.Class, 0, false)];
		...
		__ctor = deffunc(0)args(this){
			...
			setinstance(SymbolKind.Field, this, DataBlockDefine.Int64StringMap, "m_DataWrap", newexterndictionary(System.Collections.Generic.Dictionary_TKey_TValue, "g_System_Collections_Generic_Dictionary_System_Int64_DataBlockDefine_CString", typeargs(System.Int64, DataBlockDefine.CString), typekinds(TypeKind.Structure, TypeKind.Class), "ctor", 0, literaldictionary("g_System_Collections_Generic_Dictionary_System_Int64_DataBlockDefine_CString", typeargs(System.Int64, DataBlockDefine.CString), typekinds(TypeKind.Structure, TypeKind.Class))));
		}options[needfuncinfo(false)];
	};
	instance_fields {
		m_IsValid = false;
