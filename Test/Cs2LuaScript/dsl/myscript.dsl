	...
	instance_methods {
		Init = deffunc(0)args(this, obj, mb){
			...
			callexterninstance(getexterninstance(SymbolKind.Property, slider, UnityEngine.UI.Slider, "onValueChanged"), UnityEngine.Events.UnityEvent_T0, "AddListener", deffunc(0)args(v){
				...
				setinstance(SymbolKind.Field, this, MyScript, "max", typecast(v, System.Int32, TypeKind.Structure));
			}options[needfuncinfo(false), rettype(return, System.Void, TypeKind.Unknown, 0, false), paramtype(v, System.Single, TypeKind.Structure, 0, true)]);
			callinstance(this, MyScript, "Reset");
		...
		Update = deffunc(0)args(this){
			local(i); i = 0;
			while( execbinary("<", i, getexterninstance(SymbolKind.Property, getinstance(SymbolKind.Field, this, MyScript, "cubes"), System.Array, "Length"), System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure) ){
				local(offset); offset = condexpfunc(true, retval_43_25_43_44, condexp_43_25_43_44, MyScript, false, i){condexp(execbinary("==", execbinary("%", i, 2, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), 1, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure), true, 5, true, -5);}options[needfuncinfo(false), rettype(return, System.Int32, TypeKind.Structure, 0, true), paramtype(i, System.Int32, Structure, 0, true)];
			...
			setinstance(SymbolKind.Field, this, MyScript, "t", execbinary("/", ( execbinary("-", getexternstatic(SymbolKind.Property, UnityEngine.Time, "time"), getinstance(SymbolKind.Field, this, MyScript, "fogStart"), System.Single, System.Single, TypeKind.Structure, TypeKind.Structure) ), 10, System.Single, System.Single, TypeKind.Structure, TypeKind.Structure));
		...
		TestCoroutine = wrapenumerable(deffunc(1)args(this){
			...
			local(i); i = 0;
			while( execbinary("<", i, 60, System.Int32, System.Int32, TypeKind.Structure, TypeKind.Structure) ){
