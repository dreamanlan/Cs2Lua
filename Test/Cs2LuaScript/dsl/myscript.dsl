...
class(MyScript) {
	...
	instance_methods {
		...
		Update = deffunc(0)args(this){
			...
			getexterninstancestructmember(SymbolKind.Property, getexternstatic(SymbolKind.Property, UnityEngine.Camera, "main"), UnityEngine.Camera, "backgroundColor") = callexternstaticreturnstruct(UnityEngine.Color, "Lerp", wrapexternstructargument(getinstance(SymbolKind.Field, this, MyScript, "bgCurrent"), UnityEngine.Color, OperationKind.FieldReference, SymbolKind.Field, UnityEngine.Color, UnityEngine.Color), wrapexternstructargument(getinstance(SymbolKind.Field, this, MyScript, "bgColor"), UnityEngine.Color, OperationKind.FieldReference, SymbolKind.Field, UnityEngine.Color, UnityEngine.Color), getinstance(SymbolKind.Field, this, MyScript, "t"));
