...
class(MyScript) {
	...
	instance_methods {
		Init = function(this, obj, mb){
			...
			callstatic(UnityEngine.Debug, "Log", "UnityEngine.Debug:Log__Object", s);
			callinstance(mb, "StartCoroutine", callinstance(this, "TestCoroutine"));
			setinstance(this, "root", newexternobject(UnityEngine.GameObject, typeargs(), typekinds(), null, "UnityEngine.GameObject:ctor__String", "root"));
			local(slider); slider = typeas(callinstance(callstatic(UnityEngine.GameObject, "Find", "Canvas/Slider"), "GetComponent", "UnityEngine.GameObject:GetComponent__Type", typeof(UnityEngine.UI.Slider)), UnityEngine.UI.Slider, TypeKind.Class);
			local(counttxt); counttxt = typeas(callinstance(callstatic(UnityEngine.GameObject, "Find", "Canvas/Count"), "GetComponent", "UnityEngine.GameObject:GetComponent__Type", typeof(UnityEngine.UI.Text)), UnityEngine.UI.Text, TypeKind.Class);
		...
		TestCoroutine = wrapenumerable(function(this){
			...
			while( execbinary("<", i, 60, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct) ){
				...
				callstatic(UnityEngine.Debug, "Log", "UnityEngine.Debug:Log__Object", callstatic(System.String, "Format", "System.String:Format__String__Object", "{0} seconds", i));
			i = execbinary("+", i, 1, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct);
			};
			return(null);
		});
		Reset = function(this){
			if( execbinary("!=", null, getinstance(this, "cubes"), System.Object, System.Object, TypeKind.Class, TypeKind.Class) ){
				local(i); i = 0;
				while( execbinary("<", i, getinstance(getinstance(this, "cubes"), "Length"), System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct) ){
					callstatic(UnityEngine.Object, "Destroy", "UnityEngine.Object:Destroy__Object", getinstance(this, "cubes")[i + 1]);
				i = execbinary("+", i, 1, System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct);
				};
			};
			...
			local(P); P = callstatic(UnityEngine.Resources, "Load", "UnityEngine.Resources:Load__String", "Particle System");
			local(i); i = 0;
			while( execbinary("<", i, getinstance(this, "max"), System.Int32, System.Int32, TypeKind.Struct, TypeKind.Struct) ){
				...
				local(box); box = callinstance(cube, "GetComponent", "UnityEngine.GameObject:GetComponent__Type", typeof(UnityEngine.BoxCollider));
				callstatic(UnityEngine.Object, "Destroy", "UnityEngine.Object:Destroy__Object", box);
				local(p); p = typeas(callstatic(UnityEngine.Object, "Instantiate", "UnityEngine.Object:Instantiate__Object__Vector3__Quaternion", P, getstatic(UnityEngine.Vector3, "zero"), getstatic(UnityEngine.Quaternion, "identity")), UnityEngine.GameObject, TypeKind.Class);
				callinstance(getinstance(p, "transform"), "SetParent", "UnityEngine.Transform:SetParent__Transform", getinstance(cube, "transform"));
				local(ix); ix = callstatic(UnityEngine.Random, "Range", "UnityEngine.Random:Range__Int32__Int32", 0, getinstance(getinstance(this, "colors"), "Length"));
