...
class(MyScript) {
	...
	instance_methods {
		...
		Reset = deffunc(0)args(this){
			...
			setinstance(SymbolKind.Field, this, "cubes", newmultiarray(UnityEngine.GameObject, TypeKind.Class, null, 1, getinstance(SymbolKind.Field, this, "max")));
