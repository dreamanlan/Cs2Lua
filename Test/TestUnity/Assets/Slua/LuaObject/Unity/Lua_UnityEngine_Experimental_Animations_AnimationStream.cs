...
public class Lua_UnityEngine_Experimental_Animations_AnimationStream : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			UnityEngine.Experimental.Animations.AnimationStream o;
			o=new UnityEngine.Experimental.Animations.AnimationStream();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int AsHuman(IntPtr l) {
		try {
			UnityEngine.Experimental.Animations.AnimationStream self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.Animations.AnimationStream");
		addMember(l,AsHuman);
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Experimental.Animations.AnimationStream),typeof(System.ValueType));
	}
}
