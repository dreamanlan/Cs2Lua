...
public class Lua_UnityEngine_Rendering_BuiltinShaderDefine : LuaObject {
	static public void reg(IntPtr l) {
		...
		addMember(l,28,"UNITY_VIRTUAL_TEXTURING");
		addMember(l,29,"UNITY_PRETRANSFORM_TO_DISPLAY_ORIENTATION");
		addMember(l,30,"UNITY_ASTC_NORMALMAP_ENCODING");
		addMember(l,31,"SHADER_API_GLES30");
		addMember(l,32,"UNITY_UNIFIED_SHADER_PRECISION_MODEL");
		LuaDLL.lua_pop(l, 1);
	}
}
