...
public class Lua_UnityEngine_SpherecastCommand : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor__PhysicsScene__Vector3__Single__Vector3__Single__Int32_s(IntPtr l) {
		try {
			UnityEngine.SpherecastCommand o;
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ctor__PhysicsScene__Vector3__Single__Vector3__Single__Int32_s);
