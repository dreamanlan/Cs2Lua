...
public class Lua_UnityEngine_Experimental_GlobalIllumination_RectangleLight : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.RectangleLight o;
			o=new UnityEngine.Experimental.GlobalIllumination.RectangleLight();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_instanceID(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.RectangleLight self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.GlobalIllumination.RectangleLight");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Experimental.GlobalIllumination.RectangleLight),typeof(System.ValueType));
	}
}
