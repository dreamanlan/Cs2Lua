...
public class Lua_UnityEngine_Animations_AnimatorJobExtensions : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int BindStreamProperty__Animator__Transform__Type__String_s(IntPtr l) {
		try {
			UnityEngine.Animator a1;
			checkType(l,1,out a1);
			UnityEngine.Transform a2;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int BindStreamProperty__Animator__Transform__Type__String__Boolean_s(IntPtr l) {
		try {
			UnityEngine.Animator a1;
			checkType(l,1,out a1);
			UnityEngine.Transform a2;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int BindSceneProperty__Animator__Transform__Type__String_s(IntPtr l) {
		try {
			UnityEngine.Animator a1;
			checkType(l,1,out a1);
			UnityEngine.Transform a2;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int BindSceneProperty__Animator__Transform__Type__String__Boolean_s(IntPtr l) {
		try {
			UnityEngine.Animator a1;
			checkType(l,1,out a1);
			UnityEngine.Transform a2;
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,BindStreamProperty__Animator__Transform__Type__String_s);
		addMember(l,BindStreamProperty__Animator__Transform__Type__String__Boolean_s);
		addMember(l,BindCustomStreamProperty_s);
		addMember(l,BindSceneTransform_s);
		addMember(l,BindSceneProperty__Animator__Transform__Type__String_s);
		addMember(l,BindSceneProperty__Animator__Transform__Type__String__Boolean_s);
