...
public class Lua_UnityEngine_TestTools_Coverage : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetStatsFor__MethodBase_s(IntPtr l) {
		try {
			System.Reflection.MethodBase a1;
			checkType(l,1,out a1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetStatsFor__A_MethodBase_s(IntPtr l) {
		try {
			System.Reflection.MethodBase[] a1;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetStatsFor__Type_s(IntPtr l) {
		try {
			System.Type a1;
			checkType(l,1,out a1);
			var ret=UnityEngine.TestTools.Coverage.GetStatsFor(a1);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetStatsFor__MethodBase_s);
		addMember(l,GetStatsFor__A_MethodBase_s);
		addMember(l,GetStatsFor__Type_s);
