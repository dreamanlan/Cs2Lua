...
public class Lua_UnityEngine_Experimental_Animations_PropertyStreamHandle : LuaObject {
	...
	static public int IsValid(IntPtr l) {
		try {
			UnityEngine.Experimental.Animations.PropertyStreamHandle self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.Animations.PropertyStreamHandle");
		addMember(l,IsValid);
		addMember(l,Resolve);
		...
		addMember(l,GetBool);
		addMember(l,SetBool);
		createTypeMetatable(l,constructor, typeof(UnityEngine.Experimental.Animations.PropertyStreamHandle),typeof(System.ValueType));
	}
}
