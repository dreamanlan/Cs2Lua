...
public class Lua_UnityEngine_Experimental_GlobalIllumination_SpotLightBoxShape : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.SpotLightBoxShape o;
			o=new UnityEngine.Experimental.GlobalIllumination.SpotLightBoxShape();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_instanceID(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.SpotLightBoxShape self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.GlobalIllumination.SpotLightBoxShape");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Experimental.GlobalIllumination.SpotLightBoxShape),typeof(System.ValueType));
	}
}
