...
public class Lua_UnityEngine_Experimental_GlobalIllumination_SpotLightPyramidShape : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor_s(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.SpotLightPyramidShape o;
			o=new UnityEngine.Experimental.GlobalIllumination.SpotLightPyramidShape();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_instanceID(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.SpotLightPyramidShape self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.GlobalIllumination.SpotLightPyramidShape");
		addMember(l,ctor_s);
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Experimental.GlobalIllumination.SpotLightPyramidShape),typeof(System.ValueType));
	}
}
