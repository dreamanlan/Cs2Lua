...
public class Lua_UnityEngine_Experimental_GlobalIllumination_PointLight : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.PointLight o;
			o=new UnityEngine.Experimental.GlobalIllumination.PointLight();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_instanceID(IntPtr l) {
		try {
			UnityEngine.Experimental.GlobalIllumination.PointLight self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.GlobalIllumination.PointLight");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Experimental.GlobalIllumination.PointLight),typeof(System.ValueType));
	}
}
