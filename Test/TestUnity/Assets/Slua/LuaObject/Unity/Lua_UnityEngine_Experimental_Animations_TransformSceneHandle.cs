...
public class Lua_UnityEngine_Experimental_Animations_TransformSceneHandle : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			UnityEngine.Experimental.Animations.TransformSceneHandle o;
			o=new UnityEngine.Experimental.Animations.TransformSceneHandle();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int IsValid(IntPtr l) {
		try {
			UnityEngine.Experimental.Animations.TransformSceneHandle self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.Animations.TransformSceneHandle");
		addMember(l,IsValid);
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Experimental.Animations.TransformSceneHandle),typeof(System.ValueType));
	}
}
