...
public class Lua_UnityEngine_Experimental_LowLevel_PlayerLoopSystem : LuaObject {
	...
	static public int get_type(IntPtr l) {
		try {
			UnityEngine.Experimental.LowLevel.PlayerLoopSystem self;
	...
	static public int set_subSystemList(IntPtr l) {
		try {
			UnityEngine.Experimental.LowLevel.PlayerLoopSystem self;
			checkValueType(l,1,out self);
			UnityEngine.Experimental.LowLevel.PlayerLoopSystem[] v;
	...
	static public int set_updateDelegate(IntPtr l) {
		try {
			UnityEngine.Experimental.LowLevel.PlayerLoopSystem self;
			checkValueType(l,1,out self);
			UnityEngine.Experimental.LowLevel.PlayerLoopSystem.UpdateFunction v;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Experimental.LowLevel.PlayerLoopSystem");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.Experimental.LowLevel.PlayerLoopSystem),typeof(System.ValueType));
	}
}
