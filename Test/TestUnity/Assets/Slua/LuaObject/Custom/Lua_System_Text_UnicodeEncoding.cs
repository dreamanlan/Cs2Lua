...
public class Lua_System_Text_UnicodeEncoding : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ctor__Boolean__Boolean__Boolean_s(IntPtr l) {
		try {
			System.Text.UnicodeEncoding o;
			System.Boolean a1;
			checkType(l,1,out a1);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ctor__Boolean__Boolean__Boolean_s);
		...
		createTypeMetatable(l,null, typeof(System.Text.UnicodeEncoding),typeof(System.Text.Encoding));
	}
}
