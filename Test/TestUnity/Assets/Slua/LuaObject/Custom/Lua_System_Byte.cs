...
public class Lua_System_Byte : LuaObject {
	...
	static public int CompareTo(IntPtr l) {
		try {
			...
			else if(matchType(l, "CompareTo__Int32__Byte", argc, 2,typeof(System.Byte))){
				System.Byte self;
				checkType(l,1,out self);
				System.Byte a1;
				checkType(l,3,out a1);
	...
	static public int Parse_s(IntPtr l) {
		try {
			...
			else if(matchType(l, "Parse__Byte__String__NumberStyles", argc, 1,typeof(string),typeof(System.Globalization.NumberStyles))){
				System.String a1;
				checkType(l,2,out a1);
				System.Globalization.NumberStyles a2;
				checkEnum(l,3,out a2);
			...
			else if(matchType(l, "Parse__Byte__String__IFormatProvider", argc, 1,typeof(string),typeof(System.IFormatProvider))){
				System.String a1;
				checkType(l,2,out a1);
