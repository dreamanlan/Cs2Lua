...
public class Lua_System_String : LuaObject {
	...
	static public int Split(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(System.Char[]),typeof(int),typeof(System.StringSplitOptions))){
				System.String self=(System.String)checkSelf(l);
				System.Char[] a1;
				checkArray(l,2,out a1);
				System.Int32 a2;
	...
	static public int Compare_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(string),typeof(int),typeof(string),typeof(int),typeof(int),typeof(System.Globalization.CultureInfo),typeof(System.Globalization.CompareOptions))){
				System.String a1;
	...
	static public int Concat_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(System.Object),typeof(System.Object),typeof(System.Object),typeof(System.Object))){
				System.Object a1;
				checkType(l,1,out a1);
				System.Object a2;
				checkType(l,2,out a2);
