...
public class Lua_System_IO_File : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int WriteAllTextAsync__String__String__CancellationToken_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			System.String a2;
			checkType(l,2,out a2);
			System.Threading.CancellationToken a3;
			checkValueType(l,3,out a3);
			var ret=System.IO.File.WriteAllTextAsync(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int WriteAllTextAsync__String__String__Encoding__CancellationToken_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			System.String a2;
			...
			var ret=System.IO.File.WriteAllTextAsync(a1,a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int WriteAllBytesAsync_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			System.Byte[] a2;
			...
			System.Threading.CancellationToken a3;
			checkValueType(l,3,out a3);
			var ret=System.IO.File.WriteAllBytesAsync(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int AppendAllTextAsync__String__String__CancellationToken_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			System.String a2;
			...
			System.Threading.CancellationToken a3;
			checkValueType(l,3,out a3);
			var ret=System.IO.File.AppendAllTextAsync(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int AppendAllTextAsync__String__String__Encoding__CancellationToken_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			System.String a2;
			...
			System.Threading.CancellationToken a4;
			checkValueType(l,4,out a4);
			var ret=System.IO.File.AppendAllTextAsync(a1,a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,WriteAllTextAsync__String__String__CancellationToken_s);
		addMember(l,WriteAllTextAsync__String__String__Encoding__CancellationToken_s);
		addMember(l,WriteAllBytesAsync_s);
		addMember(l,AppendAllTextAsync__String__String__CancellationToken_s);
		addMember(l,AppendAllTextAsync__String__String__Encoding__CancellationToken_s);
