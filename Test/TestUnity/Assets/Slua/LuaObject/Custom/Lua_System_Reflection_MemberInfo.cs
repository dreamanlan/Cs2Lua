...
public class Lua_System_Reflection_MemberInfo : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_CustomAttributes(IntPtr l) {
		try {
			System.Reflection.MemberInfo self=(System.Reflection.MemberInfo)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.CustomAttributes);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetCustomAttributesData);
		addMember(l,Equals);
		...
		addMember(l,"CustomAttributes",get_CustomAttributes,null,true);
