...
local function set_breakpoint(file, line)
	...
	UnityEngine.Debug.Log("set_breakpoint:"..file.." line:"..tostring(line).." lastfile:"..lastfile);
...
local function remove_breakpoint(file, line)
	...
	UnityEngine.Debug.Log("remove_breakpoint:"..file.." line:"..tostring(line).." lastfile:"..lastfile);
  if file == '-' and lastfile then file = lastfile
  ...
  while true do
    ...
    elseif command == "RUN" then
      ...
      if ev == events.BREAK then
      	UnityEngine.Debug.Log("202 Paused " .. file .. " " .. tostring(line));
        server:send("202 Paused " .. file .. ".txt " .. tostring(line) .. "\n")
      elseif ev == events.WATCH then
      	UnityEngine.Debug.Log("203 Paused " .. file .. ".txt " .. tostring(line) .. " " .. tostring(idx_watch));
        server:send("203 Paused " .. file .. ".txt " .. tostring(line) .. " " .. tostring(idx_watch) .. "\n")
